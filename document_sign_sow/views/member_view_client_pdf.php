...
<script>
    ...
    function save_pdf_data(){
        ...
        if(is_attested){
            ...
            xhttp.send(data);
            alert('Document attested');
            once=0;
        }else{
            alert('Please attest  document');
        }
        }else{
            alert('Attesting already save or under progress');
        }
       ...
       document.getElementById("clear").addEventListener('click', function(){
        ...
        function atest_doc(){
         ...
         //  for(var index = 0; index < pages_arr.length; index++) {
                ...
                pages_arr[current_page] = pages_arr[current_page].replace('Sign_Here',sign_image)
                pages_arr[current_page] = pages_arr[current_page].replace('Sign_Stamp_Here',sign_stamp_image)
    ...
    function atest_doc_single_sign_on_page(){
