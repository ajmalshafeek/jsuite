...
<nav class="sidebar-nav">
    <div class="nav-container">
      ...
      <div class="nav-content tab-content">
        ...
        <li><a class="nav-link" href="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/client/files/sharedMe.php"; ?>"><i class="icofont-ui-home"></i><span>Shared Files</span></a></li>
