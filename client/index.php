...
<head>
    ...
    <style>
        ...
        .colorb{background-color: #ffb700 !important;border-color: #ffb700 !important;font-weight: 700 !important;}
...
<div class="container-fluid" style="background-color: #79dae8">
    <div class="center row">
        <div class="col-sm-6 full-height center">
            <h1 class="" style="font-style:oblique;font-size:60px; display: none">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form role="form"  id="formLogin" action="../phpfunctions/login.php" method="POST" class="needs-validation">
                    <div class="mb-4">
                    ...
                    <button type="submit" name="loginClientByForm" class="btn btn-primary col-12 colorb" value="1">SIGN IN</button>
                </form>
                <div class="mb-1 pt-3 ligthgrey" style="text-align:center;font-size:smaller">
                    <p>Can't Client Login? <a href="forgetpassword.php">Forget password</a></p>
                </div>
                <div class="mb-1 ligthgrey" style="text-align:center;font-size:smaller">
                    <p>Client Registration? <a href="registration-for-membership.php">Sign up now</a></p>
                </div>
            </div>
            <div>
