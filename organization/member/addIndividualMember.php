      ...
      <div class="container">
            ...
            <?php
              ...
              <div id="clientForm">
                  ...
                  <div class="form-group row">
                      <label for="indRefNo" class="col-sm-2 col-form-label col-form-label-lg">Membership No.</label>
                      <div class="col-sm-4"   >
                          <input type="text" class="form-control" placeholder="Enter membership no" id="indRefNo" name="membershipNo" value="<?php if(isset($data['membershipNo'])){echo $data['membershipNo'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter membership no
                          </div>
                      </div>
                      <label for="iiiam" class="col-sm-2 col-form-label col-form-label-lg">Pending Membership</label>
                      <div class="col-sm-1">
                          <input type="checkbox" class="form-control" placeholder="Pending Membership" id="iiiam" name="iiiam" <?php if(isset($data['id'])){echo 'checked';} ?> required />
                          <div class="invalid-feedback">
                              Please enter Pending Membership
                          </div>
                      </div>
                  </div>
                      <div class="form-group row">
                          <label for="profId" class="col-sm-2 col-form-label col-form-label-lg">ID</label>
                          <div class="col-sm-4" >
                              <input type="text" class="form-control" placeholder="id" id="profId" name="profId" value="<?php if(isset($data['profId'])){echo $data['profId'];} ?>" required />
                              <div class="invalid-feedback">
                                  Please enter id
                              </div>
                          </div>
                      ...
                      <div class="form-group row">
                          <label for="phone" class="col-sm-2 col-form-label col-form-label-lg">Home Phone</label>
                          <div class="col-sm-4"   >
                          ...
                          <label for="handPhone" class="col-sm-2 col-form-label col-form-label-lg">Hand Phone</label>
                          <div class="col-sm-4"   >
                              <input type="text" class="form-control" placeholder="Enter Hand Phone" id="handPhone" name="handPhone" value="<?php if(isset($data['handPhone'])){echo $data['handPhone'];} ?>" required />
                              <div class="invalid-feedback">
                                  Please Hand Phone
                              </div>
                          </div>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-sm-4"   >
                              <input type="date" class="form-control" placeholder="Enter DOB" id="dob" name="dob" value="<?php if(isset($data['dob'])){echo $data['dob'];} ?>" required />
                              <div class="invalid-feedback">
                                  Please enter dob
                              </div>
                          </div>
                          <label for="origin" class="col-sm-2 col-form-label col-form-label-lg">Contry of Origin</label>
                          <div class="col-sm-4"   >
                              <input type="url" class="form-control" placeholder="Enter contry of origin" id="origin" name="origin" value="<?php if(isset($data['origin'])){echo $data['origin'];} ?>" required />
                              <div class="invalid-feedback">
                                  Please enter contry of origin
                              </div>
                          </div>
                      </div>
                  <?php } ?>
                  ...
                  <?php if(isset($_SESSION['membership'])&&!$_SESSION['membership']){ ?>
                      ...
                      <?php } else { ?>
                          ...
                          <?php } ?>
                      <input type="hidden" name="profId" value="<?php if(isset($data['profId'])){echo $data['profId'];} ?>">
                           <?php } ?>
              ...
              <div class="form-group row" style="background: #ADD8E6;padding-top:15px;border-radius:5px;">
                <label for="address1" class="col-sm-2 col-form-label col-form-label-lg">Home Address:</label>
                <div class="col-sm-10">
        ...
        <?php if(!isset($_SESSION['membership'])){ ?>
              ...
              <div class="form-group row" style="background: #ADD8E6;padding-top:15px;border-radius:5px;">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } else { ?>
                     <input type="hidden" name="instalCountry" />
                     <input type="hidden" name="instalAddress1" />
                     <input type="hidden" name="instalAddress2" />
                     <input type="hidden" name="instalCity" />
                     <input type="hidden" name="instalState"  />
                     <input type="hidden" name="instalCountry" />
                     <input type="hidden" name="instalPCode" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" />
                  <?php } ?>
              ...
              <?php } ?>
                <div class="form-group row">
                  <label for="clientEmail" class="col-sm-2 col-form-label col-form-label-lg"><?php if(isset($_SESSION['membership'])){ echo 'Primary';} ?> Email</label>
                  <div class="col-sm-10"   >
                  ...
                  <?php if(isset($_SESSION['membership'])){ ?>
                      <div class="form-group row">
                          <label for="secondaryEmail" class="col-sm-2 col-form-label col-form-label-lg">Secondary Email</label>
                          <div class="col-sm-10"   >
                              <input type="email"  placeholder="Email Address" class="form-control" id="secondaryEmail" name="secondaryEmail" value="<?php if(isset($data['	secondaryEmail'])){echo $data['	secondaryEmail'];} ?>" required />
                              <div class="invalid-feedback">
                                  Please enter secondary email address
                              </div>
                          </div>
                      </div>
                      <div class="form-group row">
                          <label for="sendMailto" class="col-sm-2 col-form-label col-form-label-lg">Send Mail To</label>
                          <div class="col-sm-10" id="iiiam">
                              <label><input type="radio" name="sendMailto" id="statenot1" class="statenot1 " value="1" />&nbsp;Home Address</label>&nbsp;&nbsp;
                              <label><input type="radio" name="sendMailto" id="statenot2" class="statenot2" value="0" checked="checked" />&nbsp;Business Address</label>
                              <div class="invalid-feedback">
                                  Please select Send Mail To
                              </div>
                          </div>
                      </div>
                  <?php } ?>
                  ...
                  <div class="form-group row">
                      <label for="clientName" class="col-sm-2 col-form-label col-form-label-lg"><?php if(isset($_SESSION['membership'])){ echo 'Company'; } else{ echo 'Company';} ?> Name</label>
                      <div class="col-sm-10"   >
                          <input type="text" class="form-control" placeholder="Enter <?php if(isset($_SESSION['membership'])){ echo 'company'; } else{ echo 'company';} ?> name" id="clientName" name="clientName" value="<?php if(isset($data['company'])){echo $data['company'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter <?php if(isset($_SESSION['membership'])){ echo 'company'; } else{ echo 'company';} ?> name
                          </div>
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="dob" class="col-sm-2 col-form-label col-form-label-lg">Job Title</label>
                      <div class="col-sm-10"   >
                          <input type="text" class="form-control" placeholder="Enter job title" id="jobTitle" name="jobTitle" value="<?php if(isset($data['jobTitle'])){echo $data['jobTitle'];} ?>" required />
                          <div class="invalid-feedback">
                  ...
                  <div class="form-group row">
                      <label for="dob" class="col-sm-2 col-form-label col-form-label-lg">Job Code</label>
                      <div class="col-sm-10"   >
                          <input type="text" class="form-control" placeholder="Enter job code" id="jobCode" name="jobCode" value="<?php if(isset($data['jobCode'])){echo $data['jobCode'];} ?>" required />
                          <div class="invalid-feedback">
                  ...
                  <div class="form-group row">
                      <label for="sendMore" class="col-sm-4 col-form-label col-form-label-lg">Spend more than 50% time in supervising</label>
                      <div class="col-sm-8" id="iiiam">
                          <label><input type="radio" name="sendMore" id="statenot1" class="statenot1 " value="1" />&nbsp;Yes</label>&nbsp;&nbsp;
                          <label><input type="radio" name="sendMore" id="statenot2" class="statenot2" value="0" checked="checked" />&nbsp;No</label>
                          <div class="invalid-feedback">
                              Please select Send Mail To
                          </div>
                      </div>
                  ...
                  <div class="form-group row">
                      <label for="spendTimeInSupervising" class="col-sm-4 col-form-label col-form-label-lg">No. of Audit Personal Under supervising</label>
                      <div class="col-sm-8"   >
                          <input type="number" class="form-control" placeholder="Enter No. of Audit Personal Under supervising" id="spendTimeInSupervising" name="spendTimeInSupervising" value="<?php if(isset($data['spendTimeInSupervising'])){echo $data['spendTimeInSupervising'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter No. of Audit Personal Under supervising
                          </div>
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="internalAuditor" class="col-sm-4 col-form-label col-form-label-lg">No. of Years as Internal Auditor</label>
                      <div class="col-sm-8"   >
                          <input type="number" class="form-control" placeholder="Enter No. of Years as Internal Auditor" id="internalAuditor" name="internalAuditor" value="<?php if(isset($data['internalAuditor'])){echo $data['internalAuditor'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter No. of Years as Internal Auditor
                          </div>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      <label for="collageName" class="col-sm-3 col-form-label col-form-label-lg">Collage / University Name</label>
                      <div class="col-sm-9"   >
                          <input type="text" class="form-control" placeholder="Enter Collage / University Name" id="collageName" name="collageName" value="<?php if(isset($data['collageName'])){echo $data['collageName'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter Collage / University Name
                          </div>
                      </div>
                  </div>
                  <div class="form-group row">
                      <label for="highestQualification" class="col-sm-3 col-form-label col-form-label-lg">Highest Qualification</label>
                      <div class="col-sm-9"   >
                          <input type="text" class="form-control" placeholder="Enter Highest Qualification" id="highestQualification" name="highestQualification" value="<?php if(isset($data['highestQualification'])){echo $data['highestQualification'];} ?>" required />
                          <div class="invalid-feedback">
                  ...
                  <div class="form-group row">
                      <label for="proQualification" class="col-sm-3 col-form-label col-form-label-lg">Professional Qualification</label>
                      <div class="col-sm-9"   >
                          <input type="text" class="form-control" placeholder="Enter Professional Qualification" id="proQualification" name="proQualification" value="<?php if(isset($data['proQualification'])){echo $data['proQualification'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter Professional Qualification
                          </div>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      <label for="introName" class="col-sm-3 col-form-label col-form-label-lg">Introducer Name</label>
                      <div class="col-sm-9"   >
                          <input type="text" class="form-control" placeholder="Enter Introducer Name" id="introName" name="introName" value="<?php if(isset($data['introName'])){echo $data['introName'];} ?>" required />
                          <div class="invalid-feedback">
                  ...
                  <div class="form-group row">
                      <label for="introMemNo" class="col-sm-3 col-form-label col-form-label-lg">Introducer Membership No.</label>
                      <div class="col-sm-9"   >
                          <input type="text" class="form-control" placeholder="Enter Introducer Membership No." id="introMemNo" name="introMemNo" value="<?php if(isset($data['introMemNo'])){echo $data['introMemNo'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter Introducer Membership No.
                          </div>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      <label for="sponCompany" class="col-sm-3 col-form-label col-form-label-lg">Sponsorship Company</label>
                      <div class="col-sm-9"   >
                          <input type="text" class="form-control" placeholder="Enter Sponsorship Company" id="sponCompany" name="sponCompany" value="<?php if(isset($data['sponCompany'])){echo $data['sponCompany'];} ?>" required />
                          <div class="invalid-feedback">
                              Please enter Sponsorship Company
                          </div>
                      </div>
                  </div>
              </div>
