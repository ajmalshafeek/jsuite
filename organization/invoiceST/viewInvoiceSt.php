...
/*
    ...
    */
    ...
    $('#invoiceListTable tbody').on('click', 'td', function () {
      ...
      var invNo=$(this).closest('tr').find('td:eq(2)').attr('data');
      ...
      //(START)PDF NOT LOAD FIXES
        var invoicePDFHTML = "<object id='payslipPDFObject' data='" + invPDF +
            "' frameborder='0' width='100%' height='400px' style='height: 85vh;'><p>Your web browser doesn't have a PDF plugin.Instead you can<a id='payslipPDFAnchor' target='_blank' href='"
            + invPDF + "'>click here to download the PDF file.</a></p></object>";
        document.getElementById("invoicePDFModalContent").innerHTML = invoicePDFHTML;
      //(END)PDF NOT LOAD FIXES

      $.ajax({
            type  : 'GET',
            url  : '<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/phpfunctions/invoiceSt.php'; ?>',
...
<div class="content-wrapper">
    ...
    <?php echo shortcut() ?>
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item ">Statment</li>
		<li class="breadcrumb-item active">View Invoice Statment</li>
      </ol>
    </div>
	  <?php
  		 ...
  		 <div class='card mb-3 '  >
			<div class='card-header '>
              ...
              <div class='table-responsive'>
                <form action="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/invoiceSt.php"; ?>" method="POST" >
                    <?php  if($role!=1){ ?>
                  <button type="submit" id="downloadSelectedFile" name="downloadSelectedInvoiceFile" class="btn"><i class="fa fa-download"></i> Download</button>
                    ...
                    if($role==0){
                      ...
                      $table=invoiceListTableSt(null,null,null,null,null,null,$dateFrom,$dateTo,null,$_SESSION['orgId']);
                    }else{
                        $table=invoiceListTableSt(null,null,null,null,null,$_SESSION['userid'],$dateFrom,$dateTo,null,$_SESSION['orgId']);
                    }
                      echo $table;
                    ?>
      ...
      <div class="modal-dialog modal-dialog-centered modal-full" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="invoicePDFModalTitle">Invoice  </h5>
          ...
          <div class="modal-body">
            ...
            <object id="invoicePDFObject" data="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/resources/2/invoiceSt/0000000003.pdf"; ?>" frameborder="0" width="100%" height="400px" style="height: 85vh;">
                  <p>Your web browser doesn't have a PDF plugin.
                    Instead you can
                    <a id="invoicePDFAnchor" target="_blank" href="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/resources/2/invoiceSt/0000000003.pdf"; ?>">click here to
