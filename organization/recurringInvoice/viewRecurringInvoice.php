                ...
                <form action="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/invoice.php"; ?>" method="POST" >
                  ...
                  <button type="submit" id="downloadSelectedFile" name="downloadSelectedInvoiceFile" class="btn"><i class="fa fa-download"></i> Download</button>
                    ...
                    if($role==0){
                      ...
                      $table=recurringInvoiceListTable(null,null,null,null,null,null,$dateFrom,$dateTo,null,$_SESSION['orgId']);
                    }else{
                        $table=recurringInvoiceListTable(null,null,null,null,null,$_SESSION['userid'],$dateFrom,$dateTo,null,$_SESSION['orgId']);
                    }
                      echo $table;
                    ?>
