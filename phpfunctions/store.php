  ...
  if (!empty($orderid)) {
    ...
    $_SESSION['total'] = [];
      ...
      if ($result) {
          ...
          $order = getOrderDetailsForAdminID($con, $orderid);
          $to = $email;
          ...
          $body .= "<tr style=\"background-color: rgb(236,242,249)\"><td width='150px'>ORDER ID:</td><td width='150px'>" . $orderid . "</td></tr>";
      ...
      header("Location:  https://" . $_SERVER['HTTP_HOST'] . $config['appRoot'] . "/client/store/index.php");
}
