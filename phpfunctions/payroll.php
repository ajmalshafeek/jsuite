...
function payslip(){
    ...
    $slip.="<div class='row pb-0 pr-3 pl-3'>
<div class='p-1' style='border:1px solid black;border-top:0px;width:50%'><p>Basic Salary</p><p>EPF(%)</p><p>SOCSO</p><p>PCB</p></div>
<div class='p-1' style='border:1px solid black;border-top:0px;width:25%;border-left:0px;'><p style='text-align:right;'>1,800</p></div>
<div class='p-1' style='border:1px solid black;border-top:0px;width:25%;border-left:0px;'><p style='text-align:right;'>-</p><p style='text-align:right;'>11</p><p style='text-align:right;'>11</p><p style='text-align:right;'>11</p></div>
</div>";
    $slip.="<div class='row pb-0 pr-3 pl-3'>
<div class='p-1' style='border:1px solid black;border-top:0px;width:50%'>
<p>Total</p></div>
<div class='p-1' style='border:1px solid black;border-top:0px;width:25%;border-left:0px;'><p style='text-align:right;'>1,800</p></div>
<div class='p-1' style='border:1px solid black;border-top:0px;width:25%;border-left:0px;'><p style='text-align:right;'>33</p></div></div>";
...
if(isset($_GET['payslip'])){
   ...
   // $epfCalc = $payroll['epf'];
	...
	$advance=checknum($allowance) + checknum($claims) + checknum($commissions) + checknum($ot)+ checknum($bonus);
    ...
    if ($nasionalityCheck==0) {
      ...
      $totalDeductionCalc = checknum($socsoEmp) + checknum($pcbCalc)+checknum($eis)+checknum($epfEmp)+ checknum($deduction);
      ...
      $totalDeductionCalc = checknum($pcbCalc) + checknum($epfEmp)+ checknum($deduction);
...
<div class="row pb-0 pr-3 pl-3">
    ...
    if($deduction !=0){
        $slip .= '<div style="text-align:right;border-bottom:1px solid black;margin-bottom:16px;display:flex;">
            <div style="display:inline-block;width:50%;padding-right:20px;border-right:1px solid black;">-</div>
            <div style="display:inline-block;width:50%;padding-right:20px">&nbsp;' . $deduction . '</div>
        </div>';
    }
        $slip.='<!--	//allowance
                //$slip.=$adisplay; -->
